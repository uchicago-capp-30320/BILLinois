...
import os
import time
from data_utils import pull_page, get_page_info, master_pull_page
...
for i in range(220, max_pages+1):
    ...
    page_info = pull_page(i)

    # Storing all info from one page in a list for mass insert
    bills, sponsors, actions, inserts_on_page = insert_bills(page_info)
